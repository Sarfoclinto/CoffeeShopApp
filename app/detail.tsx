...
const Details = () => {
  ...
  return (
    <ScrollView>
      <View className="relative border ">
        ...
        <View className="mb-3 mt-3 py-2 rounded-t-3xl bg-white px-8 flex flex-row justify-between items-center bottom-0">
          <View>
