  ...
  return (
    <ScrollView>
      <View className="bg-white">
        <View className="order pt-3 px-6 bg-white mb-8">
          <View className="preference p-0.5 flex flex-row justify-center rounded-xl bg-slate-200 mb-3">
            <TouchableOpacity
              onPress={changeOrderType}
              className={` px-[59px] py-2 rounded-xl ${
                deliver ? "bg-[#c67c4e]" : ""
              }`}
            >
              <Text
          ...
          <View className="orderBody">
            ...
            <View className="flex flex-row gap-x-2 mt-3 mb-3">
              <TouchableOpacity className="border flex flex-row items-center gap-x-1 rounded-3xl py-1 px-2 w-fit ">
                <AntDesign name="edit" size={20} />
                <Text className="text-base font-medium ">
                  {deliver ? "Edit Address" : "Edit Pick Point"}
                </Text>
              </TouchableOpacity>
              <TouchableOpacity className="border flex flex-row items-center gap-x-1 rounded-3xl px-2 w-fit ">
                <AntDesign name="file1" size={20} />
                <Text className="text-base font-medium ">Add Note</Text>
              </TouchableOpacity>
            </View>
            <View className="border border-stone-500 border-0.5 mb-3"></View>
        ...
        <View className="others  pt-3 px-6 bg-white ">
          <View className="border flex flex-row px-5 justify-between items-center py-2 border-1 border-stone-400 rounded-2xl mb-5">
            <View className="flex flex-row items-center gap-x-3">
